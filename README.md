...
This is a console-based interactive number guessing game where the player attempts to guess a number randomly generated by the computer. The game offers different difficulty levels, a scoring system based on performance, and high score tracking.
